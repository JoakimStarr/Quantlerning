...
**篇幅与练习密度目标（2026-08-17 定稿）**：防止前半书练习过量、后半书讲解不足：
...
- **练习密度**：每课 5-8 题（4-6 选择 + 1-2 应用），数量与知识点小节数大致 1:1 封顶。整章/多课的综合题库独立成「阶段测验」入口，**禁止塞进单课文件**（历史教训：p0-l6 曾一课 58 题，其中 45 题是「前言综合题库」）
